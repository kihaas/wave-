...
app = Flask(__name__)
app.secret_key = '39a1de509f1bfdf7a9a46771f7822fc133851f05da60ece9079b6389bd89d698'  
...
def chat():
    ...
    selected_user_id = request.args.get('receiver_id', type=int)
    ...
    return render_template('chat_his.html', users=users, messages=messages, selected_user_id=selected_user_id)
